...
export default function Hero() {
  return (
    <section className="relative mx-auto flex min-h-[calc(100vh-69px)] max-w-[1200px] flex-col justify-center px-5 pb-[92px] pt-8 text-center sm:px-8">
      ...
      <div className="mx-auto mt-[34px] flex max-w-[760px] flex-wrap justify-center gap-[10px]">
        {FILTERS.map((label) => (
          <button
            key={label}
            type="button"
